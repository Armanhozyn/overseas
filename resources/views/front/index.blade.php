                ...
                <div class="col-lg-6 col-md-12 col-sm-12 right-column">
                    <div class="right-content">
                        <ul class="list clearfix">
                            <li><i class="flaticon-star"></i><a href="{{ route('eligibility') }}">Entering & Leaving From Country</a></li>
                            <li><i class="flaticon-star"></i><a href="{{ route('eligibility') }}">Visas</a></li>
                            <li><i class="flaticon-star"></i><a href="{{ route('eligibility') }}">Country Citizenship</a></li>
                            <li><i class="flaticon-star"></i><a href="{{ route('eligibility') }}">Settling In Country</a></li>
                            <li><i class="flaticon-star"></i><a href="{{ route('eligibility') }}">Help & Support</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row clearfix">
                ...
                <div class="image-box">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-6 col-sm-12 single-column">
                            <figure class="image"><img src="public/assets/images/resource/about-1.jpg" alt="wellup overseas"></figure>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 single-column">
                            <div class="text-inner">
                                <div class="shape" style="background-image: url(public/assets/images/shape/shape-5.png);"></div>
                                <div class="text">
                                    <h2>14</h2>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 single-column">
                            <figure class="image"><img src="public/assets/images/resource/about-2.jpg" alt="wellup overseas"></figure>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 single-column">
                            <figure class="image"><img src="public/assets/images/resource/about-3.jpg" alt="wellup overseas"></figure>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                <div class="content-box">
                    ...
                    <div class="inner">
                        <div class="icon"><img src="public/assets/images/icons/icon-4.png" alt="wellup overseas"></div>
        ...
        <div class="row clearfix">
            <div class="col-lg-3 col-md-6 col-sm-12 coaching-block">
                <div class="coaching-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                    <div class="inner-box">
                        <figure class="image"><img src="public/assets/images/resource/coaching-1.jpg" alt="wellup overseas"></figure>
                        <div class="content-box">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 coaching-block">
                <div class="coaching-block-one wow fadeInUp animated" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="inner-box">
                        <figure class="image"><img src="public/assets/images/resource/coaching-2.jpg" alt="wellup overseas"></figure>
                        <div class="content-box">
                            <div class="icon-box"><a href="#"><i class="flaticon-diagonal-arrow-1"></i></a></div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 coaching-block">
                <div class="coaching-block-one wow fadeInUp animated" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="inner-box">
                        <figure class="image"><img src="public/assets/images/resource/coaching-3.jpg" alt="wellup overseas"></figure>
                        <div class="content-box">
                            <div class="icon-box"><a href="#"><i class="flaticon-diagonal-arrow-1"></i></a></div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 coaching-block">
                <div class="coaching-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="inner-box">
                        <figure class="image"><img src="public/assets/images/resource/coaching-4.jpg" alt="wellup overseas"></figure>
                        <div class="content-box">
                            <div class="icon-box"><a href="#"><i class="flaticon-diagonal-arrow-1"></i></a></div>
...
<section class="destination-section">
    ...
    <div class="auto-container">
        <div class="inner-container">
            <figure class="image"><img src="public/assets/images/resource/destination-1.jpg" alt="wellup overseas"></figure>
            <div class="content-box">
                <div class="shape">
                    <div class="shape-1" style="background-image: url(public/assets/images/shape/shape-6.png);"></div>
                    <div class="shape-2" style="background-image: url(public/assets/images/shape/shape-7.png);"></div>
                </div>
                ...
                <div class="btn-box">
                    <a href="{{ route('contact') }}" class="theme-btn btn-one">Contact Us<i class="flaticon-next"></i></a>
                </div>
            </div>
        </div>
    </div>
...
<section class="chooseus-section bg-color-1 centred">
    <div class="auto-container">
        <div class="sec-title centred">
            <h6>Who We Are</h6>
            <h4>Our flexibility Makes Us Different</h4>
        </div>
            ...
            <div class="row clearfix">
                <div class="col-12 chooseus-block">
                    <div class="chooseus-block-one">
                        <div class="inner-box">
                            <p>Well-up Recruitment is a boutique recruitment firm that specializes in matching the right talent to the right job. We are a preferred
                                Recruitment Partner as we a have the knack of finding the well-up for your missing puzzle in your organization. We work on exclusive
                                assignments as we are a Preferred Recruitment Business Partner for our clients. We understand that Talent drives your business strategy and
        ...
        <div class="lower-box">
            <h2>Guiding on preparing for <a href="{{ route('eligibility') }}">eligibility exams to visa</a> assistance.</h2>
            <a href="{{ route('eligibility') }}" class="theme-btn btn-two">Get Assistance <i class="flaticon-next"></i></a>
        </div>
    </div>
</section>
        ...
        <div class="row clearfix">
            <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                <div class="team-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><img src="public/assets/images/team/team-1.jpg" alt="wellup overseas"></figure>
                            <ul class="list clearfix">
                                ...
                                <li><a href="mailto:info@wellupworld.com"><i class="flaticon-open-envelope"></i></a></li>
                            </ul>
                        </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                <div class="team-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><img src="public/assets/images/team/team-2.jpg" alt="wellup overseas"></figure>
                            <ul class="list clearfix">
                                <li class="share-option">
                                    <span class="share-icon"><i class="flaticon-share"></i></span>
                                    <ul class="share-links clearfix">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                <div class="team-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><img src="public/assets/images/team/team-3.jpg" alt="wellup overseas"></figure>
                            <ul class="list clearfix">
                                <li class="share-option">
                                    <span class="share-icon"><i class="flaticon-share"></i></span>
                                    <ul class="share-links clearfix">
